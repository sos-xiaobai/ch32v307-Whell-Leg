...
#if USART5_ENABLE
extern uint8_t usart5SendBuf[USART_SEND_BUF_SIZE + 1];
extern uint8_t usart5RecvBuf[USART_RECV_BUF_SIZE + 1];
extern RingBufferTypeDef usart5SendRingBuf;
extern RingBufferTypeDef usart5RecvRingBuf;
extern Usart_DataTypeDef usart5;
#endif
